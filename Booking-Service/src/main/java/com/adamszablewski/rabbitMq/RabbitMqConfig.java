...
//    }
    @Bean
    public Binding bindMessageObjectQueue(@Qualifier("messageObjectQueue") Queue messageObjectQueue, TopicExchange messageExchange) {
        return BindingBuilder.bind(messageObjectQueue)
                .to(messageExchange)
                .with("mqkey");
    }
    @Bean
